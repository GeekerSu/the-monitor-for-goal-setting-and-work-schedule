			...
			<div class="gtco-container">
				<div class="row clearfix">
                    <div class="col-md-12 column">
                        <div class="row clearfix">
                            <div class="col-md-12 column">                                
                                <a href="mailto:suzichao1996@sina.com">联系我们</a>
                                <a href="https://github.com/GeekerSu/Literature-reading-notes-manager">项目地址</a>
                                <br><hr style="height:1px;border:none;border-top:1px solid #555555;" /> Developed by: 胡锡鑫 高凯戈 苏子超
                            </div>
                        </div>
                    </div>
                </div>
