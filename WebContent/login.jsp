	...
	<body id="page-top">
				...
				<div class="row">
					<div class="col-lg-12 text-center">
						<div class="section-title">
							<h2>ABOUT</h2>
							<p>A creative Literature-reading-notes-manager-master produced by Macrosoft, ready to boost your business with some beautifull templates. Literature-reading-notes-manager-master is one of the best in town see more you will be amazed.</p>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-3">
						<div class="team-item">
							...
							<div class="team-text">
								<h3>HXX,HIT</h3>
								<div class="team-location">mmmmm</div>
								<div class="team-position">mmmmmm</div>
								<p>MIAOMIAOMIAO</p>
							</div>
						</div>
					</div>
					...
					<div class="col-md-3">
						<div class="team-item">
							...
							<div class="team-text">
								<h3>SZC,HIT</h3>
								<div class="team-location">MIAO</div>
								<div class="team-position">MIAO</div>
								<p>MIAO</p>
							</div>
						</div>
					</div>
			...
			<div class="container">
				...
				<div class="row">
					<div class="col-md-3">
						...
						<p>2075,2ND Department,Harbin,Heilongjiang,China</p>
						<p><i class="fa fa-phone"></i> 110</p>
						<p><i class="fa fa-envelope"></i> @qq.com</p>
					</div>
					<div class="col-md-3">
						<h3>Business Hours</h3>
						<p><i class="fa fa-clock-o"></i> <span class="day">Weekdays:</span><span>Closed</span></p>
		...
		<footer>
			<div class="container text-center">
				<p>Designed by <a href="#"><span>MOOZ</span>Themes.com</a></p>
			</div>
		</footer>
